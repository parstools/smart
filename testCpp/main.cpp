...
static void buildMst() {
    ...
    Shadow shadow;
    //link_assign(E,&shadow,(Object**)&E->next, F);
    //cout << "will shared for " << v1->ref_count << " so "<<0<<"->" <<1 << endl;
    link_assign(v0 , &shadow, (Object**)&v0->p0, v1);
    //cout << "will shared for " << v2->ref_count << " so "<<0<<"->" <<2 << endl;
    link_assign(v0 , &shadow, (Object**)&v0->p1, v2);
    //cout << "will shared for " << v4->ref_count << " so "<<2<<"->" <<4 << endl;
    link_assign(v2 , &shadow, (Object**)&v2->p0, v4);
    //cout << "will weak for " << v0->ref_count << " so "<<4<<"->" <<0 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p0, v0);
    //cout << "will weak for " << v1->ref_count << " so "<<4<<"->" <<1 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p1, v1);
    //cout << "will shared for " << v3->ref_count << " so "<<1<<"->" <<3 << endl;
    link_assign(v1 , &shadow, (Object**)&v1->p0, v3);
    //cout << "will weak for " << v0->ref_count << " so "<<3<<"->" <<0 << endl;
    link_assign(v3 , &shadow, (Object**)&v3->p0, v0);
    //cout << "will shared for " << v5->ref_count << " so "<<4<<"->" <<5 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p2, v5);
    //cout << "will shared for " << v6->ref_count << " so "<<4<<"->" <<6 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p3, v6);
    //cout << "will shared for " << v7->ref_count << " so "<<6<<"->" <<7 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p0, v7);
    //cout << "will weak for " << v2->ref_count << " so "<<6<<"->" <<2 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p1, v2);
    //cout << "will weak for " << v6->ref_count << " so "<<5<<"->" <<6 << endl;
    link_assign(v5 , &shadow, (Object**)&v5->p0, v6);
    //cout << "will shared for " << v8->ref_count << " so "<<6<<"->" <<8 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p2, v8);
    //cout << "will shared for " << v9->ref_count << " so "<<8<<"->" <<9 << endl;
    link_assign(v8 , &shadow, (Object**)&v8->p0, v9);
    //cout << "will weak for " << v7->ref_count << " so "<<8<<"->" <<7 << endl;
    link_assign(v8 , &shadow, (Object**)&v8->p1, v7);
    //cout << "will weak for " << v5->ref_count << " so "<<9<<"->" <<5 << endl;
