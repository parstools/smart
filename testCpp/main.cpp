...
static void buildMst() {
    ...
    Shadow shadow;
    //link_assign(E,&shadow,(Object**)&E->next, F);
    //cout << "będzie shared dla " << v1->use_count << " czyli "<<0<<"->" <<1 << endl;
    link_assign(v0 , &shadow, (Object**)&v0->p0, v1);
    //cout << "będzie shared dla " << v2->use_count << " czyli "<<0<<"->" <<2 << endl;
    link_assign(v0 , &shadow, (Object**)&v0->p1, v2);
    //cout << "będzie shared dla " << v4->use_count << " czyli "<<2<<"->" <<4 << endl;
    link_assign(v2 , &shadow, (Object**)&v2->p0, v4);
    //cout << "będzie weak dla " << v0->use_count << " czyli "<<4<<"->" <<0 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p0, v0);
    //cout << "będzie weak dla " << v1->use_count << " czyli "<<4<<"->" <<1 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p1, v1);
    //cout << "będzie shared dla " << v3->use_count << " czyli "<<1<<"->" <<3 << endl;
    link_assign(v1 , &shadow, (Object**)&v1->p0, v3);
    //cout << "będzie weak dla " << v0->use_count << " czyli "<<3<<"->" <<0 << endl;
    link_assign(v3 , &shadow, (Object**)&v3->p0, v0);
    //cout << "będzie shared dla " << v5->use_count << " czyli "<<4<<"->" <<5 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p2, v5);
    //cout << "będzie shared dla " << v6->use_count << " czyli "<<4<<"->" <<6 << endl;
    link_assign(v4 , &shadow, (Object**)&v4->p3, v6);
    //cout << "będzie shared dla " << v7->use_count << " czyli "<<6<<"->" <<7 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p0, v7);
    //cout << "będzie weak dla " << v2->use_count << " czyli "<<6<<"->" <<2 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p1, v2);
    //cout << "będzie weak dla " << v6->use_count << " czyli "<<5<<"->" <<6 << endl;
    link_assign(v5 , &shadow, (Object**)&v5->p0, v6);
    //cout << "będzie shared dla " << v8->use_count << " czyli "<<6<<"->" <<8 << endl;
    link_assign(v6 , &shadow, (Object**)&v6->p2, v8);
    //cout << "będzie shared dla " << v9->use_count << " czyli "<<8<<"->" <<9 << endl;
    link_assign(v8 , &shadow, (Object**)&v8->p0, v9);
    //cout << "będzie weak dla " << v7->use_count << " czyli "<<8<<"->" <<7 << endl;
    link_assign(v8 , &shadow, (Object**)&v8->p1, v7);
    //cout << "będzie weak dla " << v5->use_count << " czyli "<<9<<"->" <<5 << endl;
